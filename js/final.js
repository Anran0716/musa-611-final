...
var getColor = function(landUse){
  if (landUse.indexOf("PARK") != -1) {
    return "#d73027"
  } if (landUse=="RECREATION_SITE") {
    return "#f46d43"
  } if (landUse=="REGIONAL_CONSERVATION_WATERSHED") {
    return "#fdae61"
  } if (landUse=="YOUTH_TOT_PLAY_AREAS") {
    return "#fee08b"
  } if (landUse=="POOL") {
    return "#ffffbf"
  } if (landUse=="ICE_RINK") {
    return "#d9ef8b"
  } if (landUse=="ENVIRONMENTAL_EDUCATION_CENTER") {
    return "#a6d96a"
  } if (landUse=="ATHLETIC") {
    return "#66bd63"
  } if (landUse=="MUSEUM") {
    return "#1a9850"
  } if (landUse=="OLDER_ADULT_CENTER") {
    return "#0868ac"
  } if (landUse=="MULTI_USE") {
    return "#a8ddb5"
